...
const Sectionone = ({ sectiononeRef }) => {
    return (
        <section ref={sectiononeRef} id="sectionone">
            <div className="flex justify-center items-center w-full h-[100vh] bg-[url(https://res.cloudinary.com/dlcoacdkb/image/upload/v1740656439/background_h7tkv7.jpg)] bg-cover bg-no-repeat bg-center px-7 md:px-10 lg:px-16 xl:px-20">
