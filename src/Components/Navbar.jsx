...
const Navbar = ({ scrollToSection, activeSection }) => {
    let Links = [
        ...
        {lname:"Projects", link:"projectsRef", number:"03. ", id: "projects"},
        {lname:"Services", link:"servicesRef", number:"04. ", id: "services"},
    ...
    return (
        <div className="shadow-md w-full sticky top-0 left-0 z-40">
            <div className="md:flex items-center justify-between bg-black py-4 px-7 md:px-10 lg:px-16 xl:px-20">
                <div className="font-bold text-xl sm:text-2xl cursor-pointer flex items-center text-white">
                    <a href="/">
                        Luxury Living
                    </a>
                </div>
                    ...
                    {Links.map((link) => (
                            <li key={link.lname} className="md:ml-6 lg:ml-8 text-xl md:my-0 my-7">
                                <a onClick={() => handleLinkClick(link.link)} className={`relative text-xl font-semibold transition-colors duration-500 
                                        ...
                                        after:bg-wheat after:transition-all after:duration-500 
                                        hover:after:w-full hover:text-wheat cursor-pointer
                                        duration-500 font-bold ${activeSection === link.id ? "text-wheat after:w-full" : "text-white"}`}>
                                {link.lname}
                                </a>
                            </li>
                        ))
